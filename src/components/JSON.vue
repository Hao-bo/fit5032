...
<template>
  <div class="json-lab">
    ...
    <section class="lab-section">
      ...
      <p>
        <!-- Activity 9a: Get the company name from the bookstores object. --><!--Company:{{ bookstores.name }}-->
...
const allFamousWorks = computed(() => {
  ...
  return authors.reduce((works, author) => {
    return works.concat(author.famousWorks)
  }, [])
})
